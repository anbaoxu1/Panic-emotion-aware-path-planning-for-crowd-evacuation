...
def parse_args():
    ...
    # environment
    parser.add_argument("--scenario_name", type=str, default="office", help="name of the scenario script")
   ...
   #parser.add_argument("--learning_start_step", type=int, default=5000, help="learning start steps")
    ...
    #parser.add_argument("--batch_size", type=int, default=50, help="number of episodes to optimize at the same time")
    parser.add_argument("--memory_size", type=int, default=1e7, help="number of data stored in the memory")
    ...
    parser.add_argument("--num_units_openai", type=int, default=256, help="number of units in the mlp")
    ...
    parser.add_argument("--old_model_name", type=str, default="models/office_2101_222042_302000/", \
