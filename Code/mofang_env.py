...
class  ArmEnv(object):
    ...
    def step(self,action):
        ...
        for index in range(len(action)):
            ...
            if(getindex==len(self.list)-1):
                ...
                sp1=self.list[getindex][0:2]
                getindex+=1
                sp2=self.list[getindex][0:2]
    ...
    def compare(self,list,pos):
        ...
        for i in range(len(list)):
            ...
            k=self.dist2(float(list[i][0]),float(list[i][1]),pos[0],pos[1])
            op.append(k)
    ...
    def reset(self):
        ...
        for index in range(len(self.Agent)):
            ...
            if a==0:
                ...
                y = np.array([575,800])
            self.Agent[index].setatt(np.array([61.66,161]),np.array([0,0]),[365.9,171.8])
        """
