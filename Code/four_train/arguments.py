...
def parse_args():
    ...
    parser.add_argument("--per_episode_max_len", type=int, default=150, help="maximum episode length")
    ...
    parser.add_argument("--learning_start_step", type=int, default=100, help="learning start steps")
    ...
    parser.add_argument("--old_model_name", type=str, default="models/office_2010_291031_640100/", \
